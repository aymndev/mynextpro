...
export default function Home() {
  ...
  return (
    <div className={`rounded-[19px] ml-1 mr-3 pt-5 flex flex-row justify-center bg-gray-50 h-auto w-370 ${open ? "w-370 pl-5" : "w-418 "}`}>
      ...
      <div className=" pr-5 pl-5 justify-between">
        <div className="flex p-5 justify-center  mb-8">
          ...
          <input
            ...
            className="  focus:outline-none rounded-l-md text-black bg-gray-200 pl-[25px] pr-[60px] pt-[0px] py-[1px]"
          ...
          <div  className="ml-55">
            {/*<DrawerBaskit />*/}
            <Dropdown  buttonText={<FaShoppingBasket size={25} />}>
